...
set _DeploySetParametersFile=%RootPath%MVCPeopleAwards.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%MVCPeopleAwards.zip" (
echo "%RootPath%MVCPeopleAwards.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MVCPeopleAwards.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='obj\\MyTestWebPublish\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='127\.0\.0\.1:8888/MVCPeopleAwards\\App_Data$'
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MVCPeopleAwards.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -skip:objectname='dirPath',absolutepath='obj\\MyTestWebPublish\\Package\\PackageTmp\\App_Data$' -skip:objectname='dirPath',absolutepath='127\.0\.0\.1:8888/MVCPeopleAwards\\App_Data$' -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%MVCPeopleAwards.deploy-readme.txt" (
...
start notepad "%RootPath%MVCPeopleAwards.deploy-readme.txt"
)
echo =========================================================
goto :eof
